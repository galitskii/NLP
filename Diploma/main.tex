...
\bibitem{aho} \textbf{Ахо А., Ульман Д. Теория синтаксического анализа, перевода и компиляции.}~-- мир, 1978.~-- Т. 1.

\bibitem{forms}\textbf{ Журавлёв, Ю.И. Дискретный анализ. Формальные системы и алгоритмы}: Учебное пособие / Ю.И. Журавлёв, Ю.А. Флёров, Н.М. Вялый~-- М.: ООО Контакт Плюс, 2010.~--~ 336 с.: ил.

\bibitem{tryap} \textbf{Серебряков В. А. и др. Теория и реализация языков программирования} //М.: МЗ-Пресс.~-- 2006.~-- 357 с.
