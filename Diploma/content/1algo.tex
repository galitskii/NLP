...
Нами были написаны функции two() (алгоритм \ref{alg24}), three() и four(), которые анализируют словосочетания соответствующей длины.
...
\begin{algorithm}
	...
	\State res $\gets$ (ans, comm, ex, r\_id).simple\_rules.(res$_l[i]$)(res$_r[j]$) \Comment{Записываем ответ, правило, пример для данного правила и идентификатор правила для данного словосочетания из таблицы simple\_rules, в которой хранятся правила для словосочетаний длины $2$}
	\If{len(res) $>0$}
	\algstore{bkbreak}
	\end{algorithmic}
\end{algorithm}
