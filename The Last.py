...
def comma(l):
    ...
    if id1 + 1 < llen:
        for i in resp1:
            if i[0] == '6':
                ...
                part = '6'
                break
    if part == '6' and id1 - 4 >= 0 and left == -1: # это раньше, поскольку может быть 2 инфинитива
        for i in resl4:
            if i[0] == part:
                r = check(l[id1 - 4: id1])
                if 'N' in r:
                    ...
                    left = id1 - 4
                    break
    if part == '6' and id1 - 3 >= 0 and left == -1: 
        for i in resl3:
            if i[0] == part:
                r = check(l[id1 - 3: id1])
                if 'N' in r:
                    ...
                    left = id1 - 3
                    break
    if part == '6' and id1 - 2 >= 0 and left == -1: 
        for i in resl2:
            if i[0] == part:
                r = check(l[id1 - 2: id1])
                if 'N' in r:
                    ...
                    left = id1 - 2
                    break
    if part == '6' and id1 - 1 >= 0 and left == -1:
        for i in resl1:
            if i[0] == part:
                left = id1 - 1
                break
    print(left)
    print(l)
    if left != -1 and part == '6':
        print("Инфинитив")
        while l[left - 1] == ',' or l[left - 2] == ',' or l[left - 3] == ',' or l[left - 4] == ',':
